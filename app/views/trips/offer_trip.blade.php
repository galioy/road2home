...
@section('content')
    <div class="row padding-top-10">
        <div class="col-md-offset-2 col-md-5 no-side-padding">
            <h2>Offer your trip</h2>
        </div>
    </div>
    <div class="row">
        <div id="tabs-container" class="col-md-offset-1 col-md-6 col-lg-offset-2 col-lg-5">
        @if(Auth::user()->active)
            @if($has_vehicle)
    {{-- Steps Tabs --}}
    ...
    {{-- STEP 1 --}}
                        ...
                        {{ Form::open(['class'=>'stepform', 'data-parsley-validate'])}}
                            {{--<div class="row form-group">--}}
                                ...
                                {{--<div class="col-sm-8 text-left ">--}}
                                    {{--{{ Form::select('trip_type_dum', Config::get('enums.trip_types'), null, ['class' => 'form-control']) }}--}}
                                {{--</div>--}}
                            {{--</div>--}}
                            <div class="row form-group">
                                <div class="col-sm-3 text-right no-side-padding ">
                                ...
                                <div class="col-sm-8 text-left ">
                                    {{ Form::text('route_from_dum', null, ['id' => 'main_route_from_input', 'placeholder' => '', 'class' => 'form-control',
                                                'data-parsley-required' => 'true',
                                                'data-parsley-trigger' => 'keyup',
                                                'data-parsley-validation-threshold' => '0',
                                                'onblur' => 'calcRoute()']) }}
                                    {{ $errors->first('route_from_dum', '<span class="label label-warning">:message</span>') }}
                                </div>
                            </div>
        ...
        {{-- stop-point container --}}
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8 text-left ">
                                    {{ Form::text('route_to_dum', null, ['id' => 'main_route_to_input','placeholder' => '', 'class' => 'form-control',
                                                'data-parsley-required' => 'true',
                                                'data-parsley-trigger' => 'keyup',
                                                'data-parsley-validation-threshold' => '0',
                                                'onblur' => 'calcRoute()']) }}
                                    {{ $errors->first('route_to_dum', '<span class="label label-warning">:message</span>') }}
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                <div class="col-sm-offset-3 col-sm-8 text-left ">
                                  <div class="input-group">
                                    ...
                                    {{ $errors->first('start_date_dum', '<span class="label label-warning">:message</span>') }}
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col-sm-offset-3 col-sm-8 text-left ">
                                    <div class="inline-block">
                                        {{ Form::select('start_hour_dum', Config::get('enums.hours'), '08',['class' => 'form-control']) }}
                                    </div>
                                    <div class="inline-block">
                                        {{ Form::select('start_minutes_dum', Config::get('enums.minutes'), null, ['class' => 'form-control']) }}
                                    </div>
                                </div>
                            </div>
                            <div class="row no-side-padding padding-top-10">
                    ...
                    <div id="tab-content-3" class="col-sm-offset-2 col-sm-8">
                        {{ Form::open(['class'=>'stepform', 'data-parsley-validate'])}}
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8 text-left ">
                                    {{ Form::select('seats_dum', $seats, count($seats), ['id' => 'seatsField', 'class' => 'form-control']) }}
                                    {{ $errors->first('seats_dum', '<span class="label label-warning">:message</span>') }}
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col-sm-3 text-right no-side-padding">
                                ...
                                <div class="col-sm-8 text-left ">
                                    {{ Form::select('luggage_dum', Config::get('enums.luggage_sizes'), null, ['class' => 'form-control']) }}
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col-sm-3 text-right no-side-padding">
                                ...
                                <div class="col-sm-8 text-left ">
                                    ...
                                    <div class="row form-group no-bottom-margin">
                                        <div class="col-sm-1 text-left ">
                                            {{ Form::checkbox('children_allowed'); }}
                                        </div>
                                        <div class="col-sm-8 text-left ">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8 text-left ">
                                    {{ Form::textarea('additional_info_dum', null,
                                                        ['class' => 'form-control',
                                    ...
                                    {{ $errors->first('additional_info_dum', '<span class="label label-warning">:message</span>') }}
    ...
    {{-- STEP 4 --}}
                    <div id="tab-content-4" class="col-sm-offset-2 col-sm-8">
                        {{ Form::open(['route' => 'trips.store', 'data-parsley-validate','id'=>'offer_trip_form'])}}
                            <div class="row form-group">
                                <div class="col-sm-8 text-left no-side-padding">
                                    {{ Form::label('main_route', '', ['id' => 'main_route_label']) }}
                                </div>
                                <div class="col-sm-3 text-right no-side-padding">
                                    ...
                                    {{ $errors->first('price', '<span class="label label-warning">:message</span>') }}
                                </div>
                    ...
                    {{--stop-points-container--}}
                            ...
                            <div class="row no-side-padding padding-top-10">
                                ...
                                <div class="col-sm-2 col-sm-offset-8 no-side-padding text-center">
                                    {{ Form::submit('Create trip!', ['id' => 'finishBtn', 'class' => 'btn btn-success']) }}
                                </div>
                            </div>
                ...
                @else
                <h3>You must have a vehicle set up to your profile in order to be able to create trips.</h3>
                </br>
            ...
            @endif
        @else
            <h3>You must confirm your account in order to be able to create trips.</h3>
            </br>
